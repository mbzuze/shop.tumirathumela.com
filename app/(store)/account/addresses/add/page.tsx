  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <nav className="text-sm text-[#007185] mb-4">
        ...
        <span className="mx-1 text-[#565959]">›</span>
        <span className="text-[#C7511F]">Add a New Address</span>
      </nav>
        ...
        <div>
          ...
          <div className="flex gap-4">
            <label className="flex items-center gap-2 text-sm cursor-pointer">
              <input type="radio" name="addressType" value="Home/Residential" defaultChecked className="accent-[#e77600]" />
              Home / Residential
            </label>
            <label className="flex items-center gap-2 text-sm cursor-pointer">
              <input type="radio" name="addressType" value="Office/Business" className="accent-[#e77600]" />
              Office / Business
            </label>
          </div>
        </div>
