import { COUPON_CODES } from "@/lib/coupon-codes";
...
async function BlackFridayBanner() {
    ...
    return (
            ...
            <div className="w-full p-4 bg-yellow-300 text-black rounded shadow-md flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <div className="mt-2 text-xl font-bold">Save {formatDiscountLabel(sale.discountType, sale.discountValue)} your purchase!</div>
                </div>
            </div>                
    );
}
